    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="active treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>功能菜单</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a id="load-project-id"><i class="fa fa-circle-o"></i>档案管理</a></li>
            <li><a id="load-team-id"><i class="fa fa-circle-o"></i>限制信息管理</a></li>
            <li><a id="load-type-id"><i class="fa fa-circle-o"></i>系统管理</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i>楼栋管理</a></li>
            <li><a id="load-attachment-id"><i class="fa fa-circle-o"></i>有房无房查询</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
